...
# CONFIG
# =============================
API_BASE = "https://movie-recommendation-ml-model.onrender.com/" or "http://127.0.0.1:8000"
...
# ==========================================================
    ...
    with left:
        ...
        if data.get("poster_url"):
            st.image(data["poster_url"], use_column_width='always')
        else:
            st.write("🖼️ No poster")
    ...
    if data.get("backdrop_url"):
        ...
        st.image(data["backdrop_url"], use_column_width='always')
